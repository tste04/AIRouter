...
Engram, AIGateway) lizenziert werden — einzeln und als Distribution. Es ist die
...
| **2 — Differenzierend** | PolyForm Noncommercial 1.0.0 + kommerzielle Lizenz | Kaufgrund-Komponenten: nichtkommerziell frei, jede kommerzielle Nutzung führt zum Maintainer. | AIRouter, Engram |
...
|---|---|---|---|
| **AIRouter** | 2 | [PolyForm NC 1.0.0](LICENSE.md) | [COMMERCIAL.md](COMMERCIAL.md), Konditionen auf Verhandlungsbasis |
| **Engram** | 2 | PolyForm NC 1.0.0 | Kommerzielle Editionen, Konditionen auf Verhandlungsbasis |
| **AIGateway** | 2 *(Default)* | PolyForm NC 1.0.0 *(anzugleichen)* | Konditionen auf Verhandlungsbasis |
